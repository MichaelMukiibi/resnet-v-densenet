...
colab run --gpu t4 -s resnet-cifar10 train.py --model resnet --epochs 10 --batch_size 64 --lr 0.001 --wand_key $WANDB_API_KEY
```
...
colab run --gpu t4 -s densenet-cifar10 train.py --model densenet --epochs 10 --batch_size 64 --lr 0.001 --wand_key $WANDB_API_KEY
```
